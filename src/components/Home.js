  ...
  return (
    <>
      ...
      <div className="container">
        <div className="stats">
          <StatsCard icon="fas fa-hospital" title="Medical Facilities" value={basicStats.totalFacilities} />
          <StatsCard icon="fas fa-user-md" title="Medical Professionals" value={basicStats.totalDoctors} />
          <StatsCard icon="fas fa-procedures" title="Total Beds Available" value={basicStats.totalBeds} />
          <StatsCard icon="fas fa-ambulance" title="Emergency Centers" value={basicStats.emergencyCenters} />
        </div>
